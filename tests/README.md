...
## Resources
* [CodeIgniter 4 User Guide on Testing](https://codeigniter4.github.io/userguide/testing/<?=base_url()?>)
* [PHPUnit docs](https://phpunit.readthedocs.io/en/8.5/<?=base_url()?>)
...
The HTML files can be viewed by opening **tests/coverage/<?=base_url()?>** in your favorite browser.
